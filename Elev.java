...
public class Elev extends Utilizator{
    ...
    public String scriereCerere(String tipCerere,String fisierOut) throws Exception {
        ...
        String aux2=TipCerere.inlocuire_carnet_de_elev.name();
        String aux2f=aux2.replace("_"," ");

        if((tipCerere.compareTo(auxf))==0 )
        {
            return "Subsemnatul " + this.nume + ", elev la scoala "+ this.scoala+ ", va rog sa-mi aprobati urmatoarea solicitare: "+ auxf;
        }
        else if((tipCerere.compareTo(aux2f))==0)
        {
            return "Subsemnatul " + this.nume + ", elev la scoala "+ this.scoala+ ", va rog sa-mi aprobati urmatoarea solicitare: " +aux2f;
        }
        else {
            try{
                ...
                out.println("Utilizatorul de tip elev nu poate inainta o cerere de tip "+ tipCerere);
                bw.close();
            }
            catch (Exception e){
