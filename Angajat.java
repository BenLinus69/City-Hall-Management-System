...
public class Angajat extends Utilizator{
    ...
    public String scriereCerere(String tipCerere,String fisierOut) throws Exception {
        ...
        String aux3=TipCerere.inregistrare_venit_salarial.name();
        String aux3f=aux3.replace("_"," ");
        //System.out.println("HAIDE");

        if((tipCerere.compareTo(auxf))==0 )
        {
            return "Subsemnatul " + this.nume + ", angajat la compania "+ this.companie+ ", va rog sa-mi aprobati urmatoarea solicitare: "+ auxf;
        }
        else if((tipCerere.compareTo(aux2f))==0)
        {
            return "Subsemnatul " + this.nume + ", angajat la compania "+ this.companie+ ", va rog sa-mi aprobati urmatoarea solicitare: " +aux2f;
        }
        else if ((tipCerere.compareTo(aux3f))==0)
        {
            return "Subsemnatul " + this.nume + ", angajat la compania "+ this.companie+ ", va rog sa-mi aprobati urmatoarea solicitare: " +aux3f;
        }
        else {
            try{
                ...
                out.println("Utilizatorul de tip angajat nu poate inainta o cerere de tip "+ tipCerere);
                bw.close();
            }
            catch (Exception e){
